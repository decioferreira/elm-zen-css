module CSS.Properties.Background.Color exposing
    ( color
...
`[background-image](https://developer.mozilla.org/en-US/docs/Web/CSS/background-image)` that is
specified, although the color will still be visible through any transparency in the image.
-}
